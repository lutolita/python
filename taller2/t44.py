texto = "texto = "Frankenstein, or the Modern Prometheus
...
diccionario = contarPalabras(lista)

palabras = tuple( diccionario.keys())
frecuencia = tuple(diccionario.values())

print("palabra más repetida:", palabras[frecuencia.index(max(frecuencia))])
print("cantidad de repeticiones:", max(frecuencia))"
lista = texto.split(" ")
